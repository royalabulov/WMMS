        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WareHouse_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Markets_WareHouse_WareHouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketInventories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarketInventories_Markets_MarketId",
                        column: x => x.MarketId,
                        principalTable: "Markets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MarketInventories_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransfer_Markets_MarketId",
                        column: x => x.MarketId,
                        principalTable: "Markets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockTransfer_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransfer_WareHouse_WareHouseId",
                        column: x => x.WareHouseId,
                        principalTable: "WareHouse",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketInventories_MarketId",
                table: "MarketInventories",
                column: "MarketId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketInventories_ProductId",
                table: "MarketInventories",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransfer_MarketId",
                table: "StockTransfer",
                column: "MarketId");

            migrationBuilder.CreateIndex(
                name: "IX_StockTransfer_ProductId",
                table: "StockTransfer",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_StockTransfer_WareHouseId",
                table: "StockTransfer",
                column: "WareHouseId");

            migrationBuilder.CreateIndex(
                name: "IX_WareHouse_AppUserId",
                table: "WareHouse",
                column: "AppUserId",
                unique: true);
